...
const SignupPage = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      password: yup.string()
        .required(t('required_field'))
        .min(6, t('validation_username_length')),
            ...
            <div className="card-body d-flex flex-column flex-md-row justify-content-around align-items-center p-5">
              ...
              <Form onSubmit={handleSubmit} className="w-50">
                ...
                <Form.Floating className="mb-3">
                  ...
                  />
                  <Form.Label htmlFor="username">{t('register_username')}</Form.Label>
                ...
                <Form.Floating className="mb-4">
                  ...
                  />
                  <Form.Label htmlFor="confirmPassword">{t('confirm_password')}</Form.Label>
                  <Form.Control.Feedback tooltip type="invalid">
                    {regFailed ? t('username_exists') : t('passwords_must_match')}
