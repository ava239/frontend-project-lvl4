...
const LoginPage = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      username: yup.string().required(t('validation.required_field')),
      password: yup.string().required(t('validation.required_field')),
    }),
          ...
          <div className="card shadow-sm">
              ...
              <Form onSubmit={formik.handleSubmit} className="col-12 col-md-6 mt-3 mt-mb-0">
                ...
                <Form.Floating className="mb-3">
                  <Form.Control
                    ...
                    ref={inputRef}
                  />
                  <Form.Label htmlFor="username">{t('loginForm.fields.username')}</Form.Label>
                </Form.Floating>
            ...
            <div className="card-footer p-4">
              <div className="text-center">
                <span>{t('loginForm.no_account_link')}</span>
                &nbsp;
